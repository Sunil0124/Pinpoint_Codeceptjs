...
module.exports = {
  ...
  locators: { //page object     
      ...
      isee3: "Edit",
      editokbtn: "//div[@id='table-four-bottom']//ul//li//a",
      ...
      suspendradiobtn: "//table[@id='suspendForm:suspendTypeRadio']//tbody//tr//td//input",
  ...
  OpenTrans(value){
      ...
      else if (value.includes('Open')){I.selectOption('filterForm:statusMenu','PO')}
  ...
  //   I.wait(5)
  //   I.selectOption(this.locators.seltaxcode, '260821T2 - This is sample tax code given.')
